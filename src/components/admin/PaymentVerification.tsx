...
import { Check, X, ExternalLink, Loader2, Search, RefreshCw, Mail, BarChart, ListChecks, Clock, FileText } from "lucide-react";
...
export const PaymentVerification = () => {
  ...
  const handleSaveVerification = async () => {
    ...
    try {
      // Use the new utility function for updating payment status with history tracking
      ...
      if (paymentStatus === 'confirmed') {
        ...
        toast({
          ...
          description: `Payment for ${selectedRegistration.first_name} has been marked as rejected.`,
        });
      } else {
        toast({
          title: "Payment Updated",
          description: `Payment status for ${selectedRegistration.first_name} has been updated to ${paymentStatus}.`,
        });
      }
